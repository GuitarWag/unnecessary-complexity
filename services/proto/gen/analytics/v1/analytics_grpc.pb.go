...
const (
	AnalyticsService_Stats_FullMethodName = "/analytics.v1.AnalyticsService/Stats"
)
...
func (c *analyticsServiceClient) Stats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatsResponse)
	err := c.cc.Invoke(ctx, AnalyticsService_Stats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyticsServiceServer) Stats(context.Context, *StatsRequest) (*StatsResponse, error) {
...
func _AnalyticsService_Stats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).Stats(ctx, req.(*StatsRequest))
	}
